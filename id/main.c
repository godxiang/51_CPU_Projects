...
void EraseData(Ulongint Addr, Uchar longth){
Uchar Data[125];																															//擦除即写入0xff
Uchar i;
for(i=0;i<longth;i++)
Data[i] = 0xff;
sFLASH_WritePage(Data,Addr,longth);																				//写入 即擦除了longth 长度																														
}
